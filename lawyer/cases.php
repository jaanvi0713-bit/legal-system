    ...
    <div class="panel">
        <div class="panel-header">
            <div>
                ...
                <p class="muted"><?= __e('cases.client_label') ?> <?= e($case['client_name']) ?> · <?= e($case['client_email']) ?> · <?= e($case['client_phone'] ?: '') ?></p>
            </div>
...
<div class="panel">
    ...
    <div class="table-wrap">
        <table>
            <thead><tr><th><?= __e('common.case') ?></th><th><?= __e('common.client') ?></th><th><?= __e('common.status') ?></th><th><?= __e('common.hearing') ?></th></tr></thead>
            <tbody>
