                ...
                <section class="entity-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input id="first_name" name="first_name" required value="<?= e($client['first_name']) ?>" placeholder="e.g. Priya">
                        </div>
                        <div class="form-group">
                            <label for="last_name">Last name <span class="req" title="Required">*</span></label>
                            <input id="last_name" name="last_name" required value="<?= e($client['last_name']) ?>" placeholder="e.g. Sharma">
                        </div>
                        <div class="form-group">
                            <label for="email">Email <span class="req" title="Required">*</span></label>
                            <input id="email" type="email" name="email" required value="<?= e($client['email']) ?>" placeholder="name@company.com">
                        </div>
                        <div class="form-group">
                            <label for="phone">Phone</label>
                            <input id="phone" name="phone" value="<?= e($client['phone']) ?>" placeholder="+230 …">
                        </div>
                        <div class="form-group full">
                            <label for="address">Address</label>
                            <textarea id="address" name="address" rows="2" placeholder="Street, city, postal code"><?= e($client['address']) ?></textarea>
                        </div>
                    </div>
                </section>
                ...
                <section class="entity-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input id="username" name="username" required value="<?= e($client['username']) ?>" placeholder="Unique login ID" autocomplete="off">
                        </div>
                        <?php if (!$isEdit): ?>
                        <div class="form-group">
                ...
                <section class="entity-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input id="company_name" name="company_name" value="<?= e($client['company_name']) ?>" placeholder="Optional organization name">
                        </div>
                        <div class="form-group">
