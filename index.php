...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!in_array($role, ['admin', 'lawyer', 'client'], true)) {
        $error = 'Please select a portal role.';
        ...
        if (!$ok) {
            ...
            $error = 'This account cannot sign in as ' . ucfirst($role) . '.';
            $selectedRole = $role;
        } else {
...
<head>
    ...
    <title><?= e($appName) ?> · Login Portal</title>
                    ...
                    <form method="post" class="login-form" id="login-form">
                        ...
                        <div class="field">
                            ...
                            <div class="field-input">
                                <input type="text" id="login" name="login" required autocomplete="username" value="<?= e(post('login', '')) ?>" placeholder="Enter username">
                            </div>
                        </div>
                        ...
                        <div class="login-meta">
                            ...
                            <a class="forgot" href="#" tabindex="-1" onclick="return false;">Forgot password?</a>
                        </div>

                        <button class="login-btn" type="submit">Log in</button>
                    </form>

                    <div class="role-divider"><span>AS</span></div>
                    <div class="role-picker" role="group" aria-label="Sign in as">
                        <?php
                        $roles = [
                            'admin' => ['Admin', 'M12 3l7 4v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V7l7-4z'],
                            'lawyer' => ['Lawyer', 'M12 3v18M5 8h14M7 8l-2 10h14l-2-10'],
                            'client' => ['Client', 'M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM4 20a8 8 0 0 1 16 0'],
                        ];
                        foreach ($roles as $key => [$label, $path]):
                        ?>
