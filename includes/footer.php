...
window.LEXORA_I18N = <?= json_encode([
    ...
    'attach_default_prompt' => __('ai.attach_default_prompt'),
    'attach_too_many' => __('ai.attach_too_many'),
    'attach_type_error' => __('ai.attach_type_error'),
    'attach_size_error' => __('ai.attach_size_error'),
    'attach_stored_header' => __('ai.attach_stored_header'),
    'rename_chat' => __('ai.rename_chat'),
    'ai_copy' => __('ai.copy'),
    'ai_edit' => __('ai.edit'),
    'ai_copied' => __('ai.copied'),
    'confirmDeleteSession' => __('ai.confirm_delete_session'),
